...
1. <u>**Classification**</u>
   ...
   Common classification algorithms are <span style:"color:blue"> linear classifiers </span>, support vector machines (SVM), decision trees, k-nearest neighbor, and random forest, which are described in more detail below.
